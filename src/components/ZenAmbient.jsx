 ...
 * Single control: mute / unmute with persistence. No demo piano.
 */
export default function ZenAmbient() {
  ...
  const btnBase =
    'pointer-events-auto flex h-10 w-10 items-center justify-center rounded-full border shadow-md backdrop-blur-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2'
